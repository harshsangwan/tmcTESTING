...
echo "=== Adding JWT validation to Project Service ==="

# Create JWT utility class
mkdir -p project-service/src/main/java/com/taskmanagement/project/security
cat > project-service/src/main/java/com/taskmanagement/project/security/JwtUtil.java << 'EOF'
...
cat > project-service/src/main/java/com/taskmanagement/project/config/FeignClientConfig.java << 'EOF'
...
cat > project-service/src/main/java/com/taskmanagement/project/security/JwtAuthenticationFilter.java << 'EOF'
package com.taskmanagement.project.security;
...
cat > project-service/src/main/java/com/taskmanagement/project/security/WebSecurityConfig.java << 'EOF'
package com.taskmanagement.project.security;
...
cat > project-service/src/main/resources/application-docker.yml << 'EOF'
spring:
  application:
    name: project-service
  datasource:
    url: jdbc:mysql://mysql:3306/task_management_project?createDatabaseIfNotExist=true&allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC
    username: root
...
echo "Project Service JWT fixes completed!"